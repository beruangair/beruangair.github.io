                ...
                <div class="row">
                  <div class="col-sm-6">
                      <div class="m-b-30 p-l-20">
                        <a href="{{ url('/logo/insert') }}" id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline"></i></a>
                      </div>
                  </div>
                </div>
                @else
                      ...
                      <tbody>
                        @for ($i = 0; $i < count($profile); $i++)
                          <tr role="row" class="odd">
                            <td class="sorting_1">{{ $profile[$i]->profile}}</td>
                            <td class="actions">
                              <a href="{{ url('/get/'.$profile[$i]->id_profile) }}" class="on-default edit-row hidden" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                              <a href="{{ url('/delete/'.$profile[$i]->id_profile) }}" class="on-default remove-row hidden" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                            </td>
                          </tr>
                        @endfor
                      </tbody>
