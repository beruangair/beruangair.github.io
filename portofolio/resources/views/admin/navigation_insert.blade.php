        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card-box table-responsive">
              <div class="row">
                <div class="col-sm-12">
                  {{ Form::open(array('url' => '/insertNavigation','method' => 'post')) }}
                  <div class="row dynamic">
                    <div class="field row col-md-12">
                      <div class="col-sm-6">
                        <div class="form-group dynamic">
                          <label>Add Navigation</label>
                          <div class="input-group m-b-15">
                            <input type="text" name="navigation[]" class="form-control" id="navigationInput" required="" placeholder="Add Navigation">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-2 m-t-30">
                        <button type="button" class="add_form_field btn btn-success waves-effect waves-light">Add New Field</button>
                      </div>
                    </div>
                  </div>
