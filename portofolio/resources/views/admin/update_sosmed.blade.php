            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <p class="text-muted m-b-30 font-14">
                        Most common form control, text-based input fields. Includes support for all HTML5 types: <code>ID</code>.
                    </p>
                    <div class="row">
                        <div class="col-12">
                          {{ Form::open(array('url' => '/update','method' => 'post')) }}
                              <input type="hidden" name="id_sosmed" value="{{ $sosmed[0]->id_sosmed }}">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" name="facebook" class="form-control" id="replaceWith" required="" value="{{ $sosmed[0]->facebook }}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label>Twitter</label>
                                  <div class="input-group">
                                    ...
                                    <input type="text" name="twitter" class="form-control" id="replaceWith" required="" value="{{ $sosmed[0]->twitter }}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label>Youtube</label>
                                  <div class="input-group">
                                    ...
                                    <input type="text" name="youtube" class="form-control" id="replaceWith" required="" value="{{ $sosmed[0]->youtube }}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" name="instagram" class="form-control" id="replaceWith" required="" value="{{ $sosmed[0]->instagram }}">
                                  </div>
                              </div>
