                      ...
                      <tbody>
                        @for ($i = 0; $i < count($logo); $i++)
                          <tr role="row" class="odd">
                            <td class="sorting_1">{{ $logo[$i]->logo}}</td>
                            <td class="actions">
                              <a href="{{ url('/get/'.$logo[$i]->id_logo) }}" class="on-default edit-row hidden" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                              <a href="{{ url('/delete/'.$logo[$i]->id_logo) }}" class="on-default remove-row hidden" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                            </td>
                          </tr>
                        @endfor
                      </tbody>
